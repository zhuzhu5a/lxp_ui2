...
class Exam(LoginPage):
    ...
    def answer(self):
        ...
        self.select_all_clean('cs',
                   '#app > section > main > div > div.tw-flex.tw-flex-1.custom-py-s2.tw-overflow-auto > div > div.tw-flex-1.tw-relative.scroll-bar.custom-px-s1 > div.el-table.el-table--fit.el-table--enable-row-hover.el-table--enable-row-transition > div.el-table__body-wrapper.is-scrolling-none > table > tbody > tr:nth-child(1) > td.el-table_2_column_8.el-table__cell > div > div > div > div.tw-w-\[200px\].el-input.el-input--small > input',
                   )
        self.input('cs',
                              '#app > section > main > div > div.tw-flex.tw-flex-1.custom-py-s2.tw-overflow-auto > div > div.tw-flex-1.tw-relative.scroll-bar.custom-px-s1 > div.el-table.el-table--fit.el-table--enable-row-hover.el-table--enable-row-transition > div.el-table__body-wrapper.is-scrolling-none > table > tbody > tr:nth-child(1) > td.el-table_2_column_8.el-table__cell > div > div > div > div.tw-w-\[200px\].el-input.el-input--small > input',
                              '题库' + self.dt)
    ...
    def delete_answer(self):
        time.sleep(1)
        self.click('xpath','/html/body/section/section/main/div/div[2]/div/div[2]/div[1]/div[3]/table/tbody/tr[1]/td[5]/div/div/a[4]/span')
    ...
    def delete_file(self):
        time.sleep(1)
        self.click('xpath','/html/body/section/section/main/div/div[2]/div/div[1]/div/div[2]/span[1]')
        time.sleep(1)
    ...
    def exam(self):
        time.sleep(1)
        self.click('id','tab-exam')
        self.click('xpath','//*[@class="el-button el-button--primary is-plain is-round"]')
        time.sleep(1)
        self.input('xpath','//*[@placeholder="填写试卷名称"]',self.dt)
        self.input('xpath', '//*[@placeholder="填写答题时长"]', '5')
    ...
    def delete_exam(self):
        time.sleep(1)
        self.click('xpath',
                   '/html/body/section/section/main/div/div[2]/div/div[2]/div[1]/div[3]/table/tbody/tr[1]/td[4]/div/div/a[3]/span')
        self.click('xpath',
                   '//*[@class="el-button el-button--default el-button--small el-button--primary confirm-danger-btn"]')
        time.sleep(2)
        msg = self.text('cs', 'body > div.el-message.el-message--success.is-closable')
